...
require_once 'admin/setconfig.php';
...
<head>
  ...
  <script src="js/demo/select2.min.js"></script>
  ...
  <script src="js/demo/sweetalert2.min.js"></script>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="img/users/<?php if ($row["user_photo"] == null) {
                                                                          echo 'user.png';
                                                                        } else {
                                                                          echo $row["user_photo"];
                                                                        } ?>">
